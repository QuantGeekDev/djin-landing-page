# Jinn Blog Content Plan

## Strategy

Build **topic authority** across 3 content clusters to rank for informational queries that drive top-of-funnel traffic. Each cluster has a pillar post (comprehensive, 3000+ words) and 5-8 cluster posts (focused, 1500-2500 words) that interlink.

**Primary goal:** Rank for "AI smart display," "AI agent device," and "smart home AI" queries.
**Secondary goal:** Get cited in AI search engines (Google AI Overviews, ChatGPT, Perplexity) for smart display and AI agent queries.

## Content Clusters

### Cluster 1: AI Agents (topic authority for "AI agent" queries)

**Pillar:** "What Is an AI Agent? How It Differs from Chatbots and Smart Assistants" [PUBLISHED]
...
**Pillar:** "How to Set Up an AI-Powered Smart Home in 2026: Complete Beginner's Guide" [PUBLISHED]
...
**Pillar:** "Best AI Smart Displays in 2026: Buyer's Guide" [PUBLISHED]
...
No pillar needed — these are standalone authority-building posts.
...
**Weeks 1-2 (launch):** Publish the 5 seed posts (already done).
**Weeks 3-6:** 2 posts/week from Clusters 1 and 2 (informational, top-of-funnel).
**Weeks 7-10:** 2 posts/week mixing Cluster 3 (comparisons) and Cluster 4 (engineering).
**Ongoing:** 1-2 posts/week, rotating clusters. Update existing posts quarterly.

## SEO Formatting Rules (Every Post)

1. **H1:** Post title, includes primary keyword, under 60 chars ideal
2. **H2s:** Question format where possible, include secondary keywords
3. **First 50-70 words:** Direct answer to the main question (for AI Overview citation)
4. **One statistic per 150-200 words** with source attribution
5. **Comparison tables** in every comparison post (HTML `<table>` for snippet eligibility)
6. **Internal links:** 3-5 per post, linking to related cluster posts and the product page
7. **CTA at bottom:** Every post ends with a product CTA box
8. **Tags:** 4-6 per post, matching target keywords
9. **Reading time:** Displayed on every post
10. **Publication date:** Displayed prominently (AI engines favor fresh content)
11. **Article schema (JSON-LD):** Auto-generated per post via `generateMetadata`

## GEO (Generative Engine Optimization) Checklist

- [x] robots.txt allows GPTBot, ClaudeBot, PerplexityBot
- [x] Article schema on every blog post
- [x] FAQPage schema on landing page
- [x] Product schema on landing page
- [x] Organization schema site-wide
- [ ] Create Wikidata entry for Jinn HoloBox
- [ ] Create Crunchbase profile
- [ ] Launch on Product Hunt
- [ ] Post on r/smarthome, r/homeautomation, r/homeassistant (authentic participation)
- [ ] Create YouTube product demo
- [ ] Create llms.txt file
- [ ] Pitch reviews to Tom's Guide, TechRadar, The Verge

## Keyword Priority Map

| Priority | Keyword | Volume Est. | Difficulty | Target Page |
|----------|---------|-------------|------------|-------------|
| P0 | AI smart display | Medium | Medium | Landing page + pillar |
| P0 | Jinn HoloBox | Low (branded) | Low | Landing page |
| P0 | best smart displays 2026 | High | High | Buyer's guide post |
| P1 | AI agent device | Medium | Medium | Landing page |
| P1 | smart display comparison | Medium | Medium | Comparison post |
| P1 | AI home assistant | High | High | Cluster posts |
| P1 | on-device AI | Medium | Low | Privacy post |
| P2 | open source AI assistant | Medium | Medium | Features/blog |
| P2 | smart home automation AI | Medium | Medium | Setup guide |
| P2 | Echo Show alternative | Medium | Medium | Comparison post |
| P2 | smart home privacy | Medium | Low | Privacy post |
| P3 | voice controlled smart home | Medium | High | Setup guide |
| P3 | Matter smart home | High | High | Protocol guide |
| P3 | Home Assistant vs Alexa | Medium | Medium | Hub comparison |
