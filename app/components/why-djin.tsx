const items = [
  {
    ...
    djin: "Djin reasons, plans, uses tools, and takes real actions across your apps and devices.",
  },
  {
    ...
    djin: "Runs on hardware you own, on your network. No hosting fees. No vendor lock-in. If we disappear, your device still works.",
  },
  {
    title: "Not a smart speaker",
    alt: "Voice assistants can set timers and play music. Ask anything complex and they fall apart.",
    djin: "Handles multi-step tasks, remembers context, browses the web, drafts messages, and orchestrates sub-agents.",
  },
  {
    ...
    djin: "An animated avatar on a 5-inch display, backed by the same AI that powers enterprise automation.",
  },
  {
    title: "Not a developer tool",
    alt: "Open-source agent frameworks are powerful \u2014 if you can manage Docker, Python, and a VPS.",
    djin: "Same power, consumer packaging. Plug in, connect WiFi, start talking.",
  },
];
            ...
            <div key={item.title} className="bg-surface">
              ...
              <div className="grid md:grid-cols-2">
                ...
                <div className="px-6 py-5">
                  <div className="label text-accent-warm/50 mb-2">Djin</div>
                  <p className="text-[14px] leading-relaxed font-light">{item.djin}</p>
                </div>
              </div>
            </div>
          ))}
