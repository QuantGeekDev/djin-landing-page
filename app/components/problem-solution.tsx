  ...
  return (
    <Section>
      <SectionHeader
        ...
        subtitle="It&apos;s trapped in chat windows, phone apps, and cloud dashboards. You open a tab, type a prompt, copy the answer, close the tab. Repeat. There&apos;s no presence, no continuity, no device that just handles things for you."
        headingClassName="md:text-5xl max-w-3xl mx-auto"
      />

      <div className="divider max-w-16 sm:max-w-24 mx-auto -mt-2 sm:-mt-10 mb-10 sm:mb-16" />
