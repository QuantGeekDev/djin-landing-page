  ...
  return (
    <section className="py-20 sm:py-32 md:py-40 px-5 sm:px-6">
      <div className="max-w-3xl mx-auto">
        <div className="label text-foreground-tertiary text-center mb-4 sm:mb-6">Why Jinn</div>
        <h2 className="heading-lg text-2xl sm:text-3xl md:text-4xl text-center mb-4 sm:mb-6">
          We looked at every alternative.
        </h2>
        <p className="text-center text-foreground-secondary text-[14px] sm:text-[15px] mb-12 sm:mb-20">None of them are what we wanted. So we built it.</p>
            ...
            <div key={item.title} className="bg-surface">
              ...
              <div className="grid md:grid-cols-2">
                <div className="px-6 py-5 border-b md:border-b-0 md:border-r border-border">
                  <div className="label text-foreground-muted mb-2">Alternative</div>
                  <p className="text-[14px] text-foreground-secondary leading-relaxed font-light">{item.alt}</p>
                </div>
                <div className="px-6 py-5">
                  <div className="label text-accent-warm-dim mb-2">Jinn</div>
