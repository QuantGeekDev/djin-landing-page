...
export default function KickstarterTracker() {
  ...
  return (
    <Section id="preorder" maxWidth="3xl">
      ...
      {/* Funding meter */}
      <div className="rounded-container border border-border p-6 md:p-8 mb-8">
            ...
            >
              ...
              {isActive ? (
                <PreorderButton
                  ...
                  className="w-full py-2.5 rounded-button-rect bg-foreground text-background text-[13px] font-medium hover:bg-accent-warm hover:text-white transition-interactive flex items-center justify-center gap-2"
                >
                  Reserve &mdash; $49 Deposit
                </PreorderButton>
              ) : (
                <button disabled className="w-full py-2.5 rounded-button-rect border border-border text-foreground-muted text-[13px] cursor-not-allowed">
